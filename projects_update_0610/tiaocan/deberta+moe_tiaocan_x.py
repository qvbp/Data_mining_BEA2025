...
FIXED_CONFIG = {
    ...
    'num_classes': 3,
    'freeze_pooler': 0,
    'main_task': 'Providing_Guidance',  # 可以改为其他任务：'Mistake_Identification', 'Mistake_Location', 'Providing_Guidance'
    'max_length': 512,
    ...
    'checkpoint_dir': '/mnt/cfs/huangzhiwei/Data_mining_BAE2025/projects_update_0610/tiaocan/single_task_bayesian_optimization_results_x',
    'device': device
}
