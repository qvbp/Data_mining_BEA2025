...
FIXED_CONFIG = {
    ...
    'checkpoint_dir': '/mnt/cfs/huangzhiwei/Data_mining_BAE2025/projects_update_0610/tiaocan/bayesian_optimization_results_moe+Multitask',
    'device': device
}
