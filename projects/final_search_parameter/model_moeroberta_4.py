...
# 设置全局变量，便于配置和修改
MODEL_PATHS = {
    'roberta': '/mnt/cfs/huangzhiwei/BAE2025/models/roberta-base'
}
...
class BAE2025DataLoader:
    def __init__(
        ...
        drop_last=True,
        device=None,
        tokenizer_name=MODEL_PATHS['roberta']
    ):
...
def train_model(configs):
    ...
    if configs.use_wandb and not configs.is_sweep:
        wandb.init(
            project="BAE2025_roberta_track4",
...
def sweep_train():
    ...
    wandb.init(project="BAE2025_roberta_track4")
...
def main():
    ...
    sweep_config = {
        ...
        'parameters': {
            'model_name': {
                'values': [
                    '/mnt/cfs/huangzhiwei/BAE2025/models/roberta-base'
                ]
            },
            'label_type': {
                'values': [
    ...
    # 创建sweep
    sweep_id = wandb.sweep(sweep_config, project="BAE2025_roberta_track4")
    ...
    # 保存到JSON文件
    import json
    with open('/mnt/cfs/huangzhiwei/BAE2025/projects/tiaocan/best_model_params_roberta_track4.json', 'w') as f:
